...
/**
 * @title ObolusMerchantEscrow
 * @dev A simple escrow contract for merchants to receive payments from the Obolus protocol.
 * The deployed address acts as theMerchant ID / API Key.
 */
contract ObolusMerchantEscrow {
    ...
    /**
     * @dev Called by the Obolus Protocol (user wallet/contract) to settle a credit payment.
